...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ('first_name','surname','email','date_of_birth','rank')
...
class SchedulesAdmin(admin.ModelAdmin):
    list_display = ('Week_Number','Employee_Name','Ward_Name', 'Shift')
    search_fields = ('Week_Number','Employee_Name','Ward_Name', 'Shift')
